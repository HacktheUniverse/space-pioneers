...
event_3 = Event.create do |e|
  ...
  e.choice_1_effect = 5
  e.choice_2 = "Take medicine, such as retinoids, that mimic or enhance the body's natural capacity to repair damage caused by radiation."
  e.choice_2_effect = 6
end
...
event_5 = Event.create do |e|
  ...
  e.body = "After successive generations, your population's bones become brittle and their muscles fatigue."
  e.choice_1 = "Re-develop an appropriate set of exercises and diets based on observable data."
  e.choice_1_effect = 9
  e.choice_2 = "Increase ship rotation in order to create a more Earth-like environment."
  e.choice_2_effect = 10
end

# event_6 = Event.create do |e|
#   e.title = "Spaceship damage"
#   e.body = "Impact from microscopic dust will affect the condition of your ship."
#   e.choice_1 = "Develop a shield to avert meteoroid strikes, since space habitat does not possess a sheltering atmosphere."
